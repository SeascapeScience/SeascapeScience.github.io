...
Figure 1 Some examples of topologies of ecological forecasting systems, diagrammed from the figures provided in the papers. Each figure was distilled as a graph based on nodes and edges indicated in the diagram.
...
<img src="/images/CyclesFig2.png" width="500"/>

Figure 2 The relationship between network size (edges) and network diameter (greatest shortest node-node distance) across eighteen forecasting topologies (r = 0.64, p < 0.005).
...
Figure 3. Schematic diagram of the framework used by the Tandy Center for building forecasting systems. Arrows indicate two-way movement between any of the components of the framework, potentially multiple times.
